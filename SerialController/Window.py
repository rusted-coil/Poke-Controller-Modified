...
VERSION = "1.0-beta3 (V2.0 Modified by Moi)"
...
class PokeControllerApp:
    def __init__(self, master=None):
        ...
        self.label_9 = ttk.Label(self.camera_f2)
        self.label_9.config(text='Show Size:')
        self.label_9.grid(column='3', padx='5', row='0', sticky='ew')
        self.show_size_cb = ttk.Combobox(self.camera_f2)
        self.show_size = tk.StringVar()
        self.show_size_cb.config(textvariable=self.show_size, values='640x360 1280x720')
        ...
        self.log_scroll.grid(column='3', padx='5', pady='5', row='0', rowspan='3', sticky='ns')
        self.frame_1.config(height='720', padding='5', relief='flat', width='1280')
        self.frame_1.grid()
        self.frame_1.rowconfigure('0', uniform='None')
        '''
        ここまで
        '''
        # 仮置フレームを削除
